...
def create_optimizer(model):
    ...
    layernorm_parameters = named_parameters[391:393]
    regressor_parameters = named_parameters[393:]

    layernorm_group = [params for (name, params) in layernorm_parameters]
    regressor_group = [params for (name, params) in regressor_parameters]

    parameters = []
    parameters.append({"params": layernorm_group})
